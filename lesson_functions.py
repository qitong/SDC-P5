...
def extract_features(imgs, color_space='RGB', spatial_size=(32, 32),
    ...
    for file in imgs:
        ...
        features.append(single_img_features(image=image, color_space=color_space, spatial_size=spatial_size, hist_bins=hist_bins, orient=orient,
...
def heatmap_with_threshold(image, bbox_list, threshold):
